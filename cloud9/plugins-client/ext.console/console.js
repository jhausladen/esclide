...
//        }), winDbgConsole);
    ...
    log : function(text){
        ...
        if(tabConsole.getPage().getElementsByTagNameNS(apf.ns.aml, "scrollbar")[0] != undefined) tabConsole.getPage().getElementsByTagNameNS(apf.ns.aml, "scrollbar")[0].scrollDown();
    },
